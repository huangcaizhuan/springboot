...
+function ($) {
    ...
    $(document).on(BJUI.eventType.initUI, function(e) {
        ...
        $box.find('[data-toggle="ztree"]').each(function() {
            ...
            if (!op.maxAddLevel)   op.maxAddLevel   = 5
            ...
            var setting = {
                ...
                callback: {
                    ...
                    beforeEditName : op.beforeEditName ? op.beforeEditName.toFunc() : null,
                    onRemove      : op.onRemove     ? op.onRemove.toFunc()     : null,
                    onRename		:  op.onRename     ? op.onRename.toFunc()     : null,
                ...
                if (!$add.length) {
                    if (level < op.maxAddLevel) {
                        ...
                        $add.on('click', function(){
                            zTree.addNodes(treeNode, {name:'未命名分类'})
                        })
                    }
                }
