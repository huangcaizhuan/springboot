...
+function ($) {
    ...
    Tabledit.prototype.add = function($table, num) {
        ...
        for (var i = 0; i < num; i++) {
            ...
            $table.trigger('afteraddtr.bjui.tabledit',[$addTr]);
        }     
        ...
        $addTr.on('dblclick',function(){
        	var editrs = $addTr.siblings('tr');
        	_doEdit($addTr);
        });
